...
export default class ShareSettingForm extends Component {
  static displayName = 'ShareSettingForm';
              ...
              <IcePanel.Body>
                <div>
                  <Row style={styles.formItem}>
                    ...
                    <Col s="12" l="10">
                      <IceFormBinder name="AccessKey" required={false} message="标题名称必须填写">
                        <Input style={{
                            width: '100%'
                          }}/>
                      </IceFormBinder>
