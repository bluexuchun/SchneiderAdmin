...
export default class ComplexTabTable extends Component {
  ...
  componentWillMount(){
    const that=this;
    const result = ajaxTo('api.php?entry=sys&c=tags&a=tags&op=display');
...
that.setState({allData: res.data,pageNum:res.totle,currentPageNum:res.psize});
  ...
  deleteId = (id) => {
    console.log(id);
    ajaxTo('api.php?entry=sys&c=tags&a=tags&op=delete',{'tid':id});
