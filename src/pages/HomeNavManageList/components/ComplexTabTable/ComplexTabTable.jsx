...
const tabs = [
  { tab: "首页导航列表", key: 0, content: "/homenavmanagelist"},
  { tab: "新建首页导航", key: 1, content: "/homenavmanage/create"},
];
...
export default class ComplexTabTable extends Component {
  ...
  componentWillMount(){
    const that=this;
    const result = ajaxTo('api.php?entry=sys&c=navbar&a=navbarManage&op=display');
  ...
  deleteId = (id) => {
    console.log(id);
    ajaxTo('api.php?entry=sys&c=navbar&a=navbarManage&op=del',{'nid':id});
  ...
  renderOperations = (value, index, record) => {
    const toUrl = '/homenavmanage/'+record.id;
    return (
