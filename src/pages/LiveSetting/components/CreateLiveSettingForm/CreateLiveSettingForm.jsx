...
const tabs = [
  { tab: "直播间列表", key: 0, content: "/livesettinglist"},
  { tab: "创建直播间", key: 1, content: "/livesetting/create"},
];
...
export default class CreateLiveSettingForm extends Component {
  static displayName = 'CreateLiveSettingForm';
